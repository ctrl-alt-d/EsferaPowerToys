...
export class VisualitzadorModal {
    ...
    creaOverlay() {
        ...
        overlay.innerHTML = `
            ...
            <div class="ptv-preview-disclaimer" role="status" aria-live="polite">
                Funcionalitat en previsualització i en proves. Encara no gestiona l’estada en empresa ni els RA opcionals.
            </div>
    ...
    injectStyles() {
        ...
        style.textContent = `
            ...
            .ptv-student-select { min-width:260px; max-width:460px; min-height:45px; flex:1; background:var(--ptv-surface2); color:var(--ptv-text); border:1px solid var(--ptv-border); border-radius:8px; padding:9px 12px; font-size:1.4rem; }
            ...
            .ptv-preview-disclaimer { margin:14px 24px 0; padding:12px 16px; border:1px solid var(--ptv-yellow); border-left:6px solid var(--ptv-yellow); border-radius:8px; background:var(--ptv-yellow-dim); color:var(--ptv-yellow); font-size:1.32rem; line-height:1.45; }
